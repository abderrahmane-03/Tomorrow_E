...
<div><button onclick="showform()" class="flex ml-44 mt-4 bg-violet-200  px-6 py-2 rounded-lg text-violet-500 font-semibold text-sm transition duration-300 ease-in-out transform hover:translate-y-0.5">
                    Add a New Event
                </button>
            </div>
  ...
  @csrf
    <div class="grid gap-4 mb-4 sm:grid-cols-2">
        ...
        <div>
            ...
            <input type="datetime-local" name="date" id="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 ">
        </div>
        <div>
