                ...
                <div class="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                    ...
                    <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                        ...
                        <form  method="post" action="{{route('reservation.accept',$reservation)}}">
                            @csrf
                            @method("PUT")
                            <button type="submit" class="bg-green-200 text-green-500 rounded-lg p-3 ml-3">Accept</button>
                        </form>
                        <form method="post" action="{{route('reservation.reject',$reservation)}}">
                            @csrf
                            @method("PUT")
                            <button type="submit" class="ml-3 bg-red-200 text-red-500 p-3 rounded-lg">Reject</button>
                        </form>
                    </p>
