<x-app-layout>
    @if (!function_exists('encodeTicketDetails'))
        ...
        @endphp
    @endif
    <div class="flex-col ml-4"><a class="mt-5 inline-flex bg-yellow-200 font-bold text-sm rounded-lg w-10 m-2 px-2.5 py-0.5" href="{{route('participateur')}}"><svg class="w-6 h-6 text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
   ...
   @foreach ($tickets as $ticket)
        <div class="ticket w-80 mb-10 ml-10 bg-yellow-200 relative mt-10">
            ...
            <div class="serial px-25 py-25 relative">
                ...
                <!-- Display the QR code -->
                <!-- Display the QR code -->
                <img class="mx-auto" src="https://api.qrserver.com/v1/create-qr-code/?size=70x70&data={{ urlencode(encodeTicketDetails($ticket)) }}" alt="QR Code"><table class="ml-28 numbers">
                    <tr>
